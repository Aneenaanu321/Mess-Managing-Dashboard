...
export default function PortalQuotationsPage() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h1 className="font-display text-2xl font-semibold tracking-tight text-slate-900">Quotations</h1>
      ...
      <Card className="overflow-hidden">
        ...
        {isError && <p className="p-8 text-sm text-red-600">Couldn&apos;t load quotations.</p>}
        {!isLoading && !isError && (quotations?.length ?? 0) === 0 && (
          <div className="px-8 py-14 text-center">
            <p className="font-medium text-slate-800">No quotations yet</p>
