...
export default function NewPurchaseOrderPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      router.push(`/customer-orders/${po.id}`);
    } catch (err) {
  ...
  return (
    <div className="mx-auto max-w-2xl">
      <h1 className="mb-6 text-xl font-semibold text-primary">{getNewItemLabel("/customer-orders")}</h1>
      ...
      <Card className="p-6">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <Label htmlFor="opportunityId">Deal ID (optional)</Label>
              <Input
                id="opportunityId"
