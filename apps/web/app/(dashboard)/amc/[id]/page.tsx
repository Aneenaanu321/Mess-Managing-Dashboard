    ...
    <div>
      <div className="mb-6 flex items-start justify-between gap-4">
        <div>
          ...
          <h1 className="text-xl font-semibold text-slate-900">{contract.code}</h1>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <Card className="p-5">
          <h2 className="mb-3 text-sm font-semibold text-slate-900">Covered Devices</h2>
            ...
            <ul className="space-y-1.5 text-sm">
              {contract.devices.map((d) => (
                <li key={d.id} className="flex justify-between border-b border-slate-100 pb-1.5">
                  <span className="text-slate-900">{d.device.serialNumber}</span>
