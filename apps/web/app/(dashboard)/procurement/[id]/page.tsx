    ...
    <div className="mx-auto max-w-3xl">
      <div className="mb-6 flex items-start justify-between">
        <div>
          ...
          <h1 className="text-xl font-semibold text-slate-900">{po.vendor?.name}</h1>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <Card className="p-5">
          ...
          <div className="space-y-2 text-sm">
            {(po.lineItems ?? []).map((li) => (
              <div key={li.id} className="flex items-center justify-between border-b border-slate-100 pb-2">
                <div>
                  <p className="font-medium text-slate-900">{li.product.sku}</p>
