...
export default function InstallationsPage() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-xl font-semibold text-primary">{getPageLabel("/site-installations")}</h1>
      ...
      <Card className="overflow-hidden">
        ...
        {isError && <p className="p-6 text-sm text-red-600 dark:text-red-400">Couldn&apos;t load installations.</p>}
