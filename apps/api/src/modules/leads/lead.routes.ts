...
router.get("/assignable-owners", authorize(PERMISSIONS.LEAD_ASSIGN), asyncHandler(leadController.assignableOwners));
...
router.post("/bulk-assign", authorize(PERMISSIONS.LEAD_ASSIGN), asyncHandler(leadController.bulkAssign));
